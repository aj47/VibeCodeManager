...
export class OAuthCallbackServer {
  ...
  private handleOAuthCallback(url: URL, res: ServerResponse): void {
    ...
    if (error) {
      res.end(`
        ...
        <html>
        <head>
          <title>OAuth Error - VibeCodeManager</title>
          <style>
      ...
      res.end(`
        ...
        <html>
        <head>
          <title>OAuth Success - VibeCodeManager</title>
          <style>
            body { font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif; margin: 40px; text-align: center; }
        ...
        <body>
          <div class="container">
            ...
            <p class="success">✓ VibeCodeManager has been authorized to access the MCP server.</p>
  ...
  private handleRootRequest(res: ServerResponse): void {
    ...
    res.end(`
      ...
      <html>
      <head>
        <title>VibeCodeManager OAuth Callback Server</title>
        <style>
          body { font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif; margin: 40px; text-align: center; }
          .container { max-width: 500px; margin: 0 auto; }
        </style>
      ...
      <body>
        <div class="container">
          <h1>VibeCodeManager OAuth Callback Server</h1>
