 ...
 *
 * Allows VibeCodeManager to spawn internal sub-sessions of itself as ACP-style agents.
...
export function getInternalAgentInfo() {
  return {
    ...
    description: 'An internal sub-session of VibeCodeManager itself. Can perform any task the main agent can, with access to all configured MCP tools. Useful for parallel task execution or isolating complex sub-tasks.',
