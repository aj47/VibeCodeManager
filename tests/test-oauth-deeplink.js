...
const testCases = [
  {
    ...
    url: 'vibecode://oauth/callback?code=test123&state=abc456',
    expected: {
      protocol: 'vibecode:',
      host: 'oauth',
      pathname: '/callback',
  ...
  },
  {
    ...
    url: 'vibecode:/oauth/callback?code=test456&state=xyz789',
    expected: {
      protocol: 'vibecode:',
  ...
  },
  {
    ...
    url: 'vibecode://oauth/callback?error=access_denied&error_description=User%20denied',
    expected: {
      protocol: 'vibecode:',
      pathname: '/oauth/callback',
      error: 'access_denied',
  ...
  },
  {
    ...
    url: 'vibecode:///oauth/callback?code=test789',
    expected: {
      protocol: 'vibecode:',
      pathname: '/oauth/callback',
      code: 'test789'
  ...
  },
  {
    ...
    url: 'VIBECODE://oauth/callback?code=test999&state=upper',
    expected: {
      protocol: 'vibecode:', // URL constructor normalizes to lowercase
      host: 'oauth',
      pathname: '/callback',
      code: 'test999',
      state: 'upper'
